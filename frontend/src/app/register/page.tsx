...
import { Swords, Mail, Lock, User, ArrowRight, Loader2, AlertCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative">
      {/* Background effects */}
      <div className="absolute inset-0 bg-gradient-to-b from-purple-950/20 via-zinc-950 to-zinc-950" />
      <div className="absolute top-0 right-1/3 w-[600px] h-[400px] bg-purple-500/6 rounded-full blur-3xl" />
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="glass-card p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-zinc-400">Start battle-testing your startup ideas</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="register-confirm" className="block text-sm font-medium text-zinc-300 mb-1.5">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500" />
